...
# Vano AL GREZZO: larghezza 169,1 dopo il rilievo in sito (la camera singola e'
# larga 277 e il muro verso la trave T2 non si puo' spostare)
VANO = [
    (0, 0), (395, 0), (395, 27), (369, 27), (369, 80),
    (392, 80), (392, 169.1), (90, 169.1), (90, 244.1), (0, 244.1),
]
...
RIV_H = cp.H_RIV          # a filo trave (ultimo corso tagliato) o a 240 a corsi interi
SFRIDO = 0.15
...
ARREDO = [
    ...
    ("lavatrice", "LAVATRICE 60x60", 15, 174.6, 60, 60),
]

# Box doccia a nicchia: anta = tratto coperto da chiusa, luce = passaggio da aperta
BOX = dict(fronte_x=287, fronte_y=(2, 167.1), anta=(2, 122), luce=60)
...
NOTE = [
    "Rivestimento interno 2 cm (piastrella + colla) su tutte le pareti: misure FINITE 165,1 x 391 cm contro 169,1 x 395 al grezzo. Tutte le quote e l'arredo si riferiscono al finito.",
    ...
    "Box a nicchia 165,1: anta scorrevole a 2 pannelli, 120 da chiusa e 60 da aperta, + fisso 45. Luce netta di accesso alla doccia 60 cm.",
    "Piatto doccia 165x80 su misura a filo colonna di scarico; nicchia 23x90 sotto la finestra da tamponare (seduta h 45). Porta 80x210 a scomparsa: parete finita min. 12,5 cm.",
...
righe = [
    ...
    f"  = {RIV_MQ:.2f} mq",
    f"  {RIV_CORSI} corsi da {cp.RIV_Y:.0f}" + (", l'ultimo tagliato" if cp.FORMATO.get("riv_h") else " interi"),
